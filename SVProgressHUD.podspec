Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |core|
    ...
    core.resource_bundles = {'SVProgressHUD' => ['SVProgressHUD/*.png','SVProgressHUD/PrivacyInfo.xcprivacy']}
  end

  s.subspec 'AppExtension' do |ext|
    ext.source_files = 'SVProgressHUD/*.{h,m}'
    ext.resource_bundles = {'AppExtension' => ['SVProgressHUD/*.png','SVProgressHUD/PrivacyInfo.xcprivacy']}
